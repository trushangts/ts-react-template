...
export default class OutlookCompose extends React.Component {
  state = {
    cc: false,
    bcc: false,
    attachments: false,
  ...
  handleSubmit = e => {
    ...
    setTimeout(() => {
      this.props.history.push("/outlook");
    }, 1000);
  };
  ...
  render() {
    let ccTrigger = !this.state.cc ? (
      <em>
        <OverlayTrigger
          placement="bottom"
          overlay={<Tooltip id="cc-tooltip">Carbon Copy</Tooltip>}
        >
          <a href="#/" onClick={this.addCarbonCopy}>
            CC
          </a>
        </OverlayTrigger>
      </em>
    ...
    let bccTrigger = !this.state.bcc ? (
      <em>
        <OverlayTrigger
          placement="bottom"
          overlay={<Tooltip id="bcc-tooltip">Blind Carbon Copy</Tooltip>}
        >
          <a href="#/" onClick={this.addBlindCarbonCopy}>
            BCC
          </a>
        </OverlayTrigger>
      </em>
    ...
    return (
      <div className="table-wrap custom-scroll">
        <h2 className="email-open-header">
          ...
          <OverlayTrigger
            placement="left"
            overlay={<Tooltip id="print-message-tooltip">Print</Tooltip>}
          >
            <a href="#/" className="txt-color-darken pull-right">
            ...
            <div className="row">
              <div className="form-group">
                ...
                <div className="col-md-11">
                  ...
                  >
                    <option value="sunny.orlaf@smartadmin.com">
                      sunny.orlaf@smartadmin.com
                    </option>
                    <option value="rachael.hawi@smartadmin.com">
                      rachael.hawi@smartadmin.com
                    </option>
                    <option value="michael.safiel@smartadmin.com">
                      michael.safiel@smartadmin.com
                    </option>
                    <option value="alex.jones@infowars.com">
                      alex.jones@infowars.com
                    </option>
                    <option value="oruf.matalla@gmail.com">
                      oruf.matalla@gmail.com
                    </option>
                ...
                <div className="form-group">
                  ...
                  <div className="col-md-11">
                    ...
                    >
                      ...
                      <option value="hr@smartadmin.com">
                        hr@smartadmin.com
                      </option>
                      <option value="IT@smartadmin.com">
                        IT@smartadmin.com
                      </option>
                    </Select2>
                    {bccTrigger}
              ...
              <div className="form-group">
                ...
                <div className="col-md-11">
                  ...
                  <OverlayTrigger
                    placement="bottom"
                    overlay={
                      <Tooltip id="Attachments-tooltip">Attachments</Tooltip>
                    }
                  >
                    <em>
                      <a
        ...
        <div className="email-infobox">
          <div className="well well-sm well-light">
            ...
            <ul className="list-unstyled">
              <li>
                <i className="fa fa-file fa-fw text-success" />
                <a href="#/"> #4831 - Paid</a>
              </li>
              <li>
                <i className="fa fa-file fa-fw text-danger" />
                <a href="#/">
                  <strong> #4835 - Unpaid</strong>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="well well-sm well-light">
            ...
            <p>
              <span className="label label-success">
                ...
                <strike>Agenda Review @ 10 AM</strike>{" "}
              </span>
            </p>

            <p>
              <span className="label label-primary">
                <i className="fa fa-clock-o" /> Client Meeting @ 2:30 PM
              </span>
            </p>

            <p>
              <span className="label label-warning">
                <i className="fa fa-clock-o" /> Salary Review @ 4:00 PM
              </span>
            </p>
          </div>
