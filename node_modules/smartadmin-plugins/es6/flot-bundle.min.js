...
!(function(t) {
  ...
  (function(t) {
    ...
    function e(e, n, a, r) {
      ...
      function c(i) {
        t.extend(!0, nt, i),
          i && i.colors && (nt.colors = i.colors),
          null == nt.xaxis.color &&
            (nt.xaxis.color = t.color
              .parse(nt.grid.color)
              .scale("a", 0.22)
              .toString()),
          null == nt.yaxis.color &&
            (nt.yaxis.color = t.color
              .parse(nt.grid.color)
              .scale("a", 0.22)
              .toString()),
          null == nt.xaxis.tickColor &&
            (nt.xaxis.tickColor = nt.grid.tickColor || nt.xaxis.color),
          null == nt.yaxis.tickColor &&
            (nt.yaxis.tickColor = nt.grid.tickColor || nt.yaxis.color),
          null == nt.grid.borderColor && (nt.grid.borderColor = nt.grid.color),
          null == nt.grid.tickColor &&
            (nt.grid.tickColor = t.color
              .parse(nt.grid.color)
              .scale("a", 0.22)
              .toString());
        var o,
        ...
        for (
          nt.xaxis.noTicks &&
            null == nt.xaxis.ticks &&
            (nt.xaxis.ticks = nt.xaxis.noTicks),
            nt.yaxis.noTicks &&
              null == nt.yaxis.ticks &&
              (nt.yaxis.ticks = nt.yaxis.noTicks),
            nt.x2axis &&
              ((nt.xaxes[1] = t.extend(!0, {}, nt.xaxis, nt.x2axis)),
              (nt.xaxes[1].position = "top"),
              null == nt.x2axis.min && (nt.xaxes[1].min = null),
              null == nt.x2axis.max && (nt.xaxes[1].max = null)),
            nt.y2axis &&
              ((nt.yaxes[1] = t.extend(!0, {}, nt.yaxis, nt.y2axis)),
              (nt.yaxes[1].position = "right"),
              null == nt.y2axis.min && (nt.yaxes[1].min = null),
              null == nt.y2axis.max && (nt.yaxes[1].max = null)),
            nt.grid.coloredAreas && (nt.grid.markings = nt.grid.coloredAreas),
            nt.grid.coloredAreasColor &&
              (nt.grid.markingsColor = nt.grid.coloredAreasColor),
            nt.lines && t.extend(!0, nt.series.lines, nt.lines),
            nt.points && t.extend(!0, nt.series.points, nt.points),
            nt.bars && t.extend(!0, nt.series.bars, nt.bars),
            null != nt.shadowSize && (nt.series.shadowSize = nt.shadowSize),
            null != nt.highlightColor &&
              (nt.series.highlightColor = nt.highlightColor),
            o = 0;
          o < nt.xaxes.length;
          ++o
        )
      ...
      function b() {
        ...
        for (e = 0; e < ot.length; ++e) {
          ...
          if (r.bars.show) {
            ...
            r.bars.horizontal
              ? ((M += W), (T += W + r.bars.barWidth))
              : ((w += W), (C += W + r.bars.barWidth));
          }
          i(r.xaxis, w, C), i(r.yaxis, M, T);
        }
        t.each(d(), function(t, i) {
          i.datamin == g && (i.datamin = null),
            i.datamax == x && (i.datamax = null);
        });
      }
      function v() {
        e
          ...
          (at = new i("flot-base", e)),
          (rt = new i("flot-overlay", e)),
          (st = at.context),
          (ct = rt.context),
          (lt = t(rt.element).unbind());
        var o = e.data("plot");
        o && (o.shutdown(), rt.clear()), e.data("plot", gt);
      }
      function k() {
        nt.grid.hoverable && (lt.mousemove(X), lt.bind("mouseleave", Y)),
          nt.grid.clickable && lt.click(q),
          l(mt.bindEvents, [lt]);
      }
      function y() {
        bt && clearTimeout(bt),
          lt.unbind("mousemove", X),
          lt.unbind("mouseleave", Y),
          lt.unbind("click", q),
          l(mt.shutdown, [lt]);
      }
      function w(t) {
        ...
        "x" == t.direction
          ? ((e = t.scale = dt / Math.abs(n(t.max) - n(t.min))),
            (o = Math.min(n(t.max), n(t.min))))
          : ((e = t.scale = pt / Math.abs(n(t.max) - n(t.min))),
            (e = -e),
        ...
        for (
          var i = t.options,
            ...
            a =
              o ||
              ("x" == t.direction
                ? Math.floor(at.width / (e.length || 1))
                : null),
        ...
        t.each(a ? ht : ft, function(t, e) {
          ...
          a
            ? ((o += s),
              "bottom" == n
                ? ((ut.bottom += o + l),
                  (i.box = { top: at.height - ut.bottom, height: o }))
                : ((i.box = { top: ut.top + l, height: o }), (ut.top += o + l)))
            : ((e += s),
              "left" == n
                ? ((i.box = { left: ut.left + l, width: e }),
                  (ut.left += e + l))
                : ((ut.right += e + l),
                  (i.box = { left: at.width - ut.right, width: e }))),
          (i.position = n),
          (i.tickLength = r),
          (i.box.padding = s),
          (i.innermost = c);
      ...
      function T(t) {
        "x" == t.direction
          ? ((t.box.left = ut.left - t.labelWidth / 2),
            (t.box.width = at.width - ut.left - ut.right + t.labelWidth))
          : ((t.box.top = ut.top - t.labelHeight / 2),
            (t.box.height = at.height - ut.bottom - ut.top + t.labelHeight));
      }
      function W() {
        var i,
        ...
        if (null == e)
          for (e = 0, i = 0; i < ot.length; ++i)
            e = Math.max(
              e,
              2 * (ot[i].points.radius + ot[i].points.lineWidth / 2)
            );
        ...
        t.each(d(), function(t, i) {
          ...
          (ut.left = Math.ceil(Math.max(o.left, ut.left))),
          (ut.right = Math.ceil(Math.max(o.right, ut.right))),
          (ut.top = Math.ceil(Math.max(o.top, ut.top))),
          (ut.bottom = Math.ceil(Math.max(o.bottom, ut.bottom)));
      }
      function S() {
        var i,
          e = d(),
        ...
        for (var n in ut)
          ut[n] +=
            "object" == typeof nt.grid.borderWidth
              ? o
                ? nt.grid.borderWidth[n]
                : 0
              : o
                ? nt.grid.borderWidth
                : 0;
        ...
        (dt = at.width - ut.left - ut.right),
          (pt = at.height - ut.bottom - ut.top),
          t.each(e, function(t, i) {
            w(i);
          }),
          o && O(),
      ...
      function I(i) {
        ...
        e =
          "number" == typeof n.ticks && n.ticks > 0
            ? n.ticks
            : 0.3 * Math.sqrt("x" == i.direction ? at.width : at.height);
        var a = (i.max - i.min) / e,
      ...
      function N() {
        st.save(),
          st.translate(ut.left, ut.top),
          (st.fillStyle = et(
            nt.grid.backgroundColor,
            pt,
            0,
            "rgba(255, 255, 255, 0)"
          )),
          st.fillRect(0, 0, dt, pt),
          st.restore();
      }
      function D() {
        var i, e, o, n;
              ...
              if (!c || !h)
                if (
                  ...
                  var f = r.lineWidth || nt.grid.markingsLineWidth,
                    u = f % 2 ? 0.5 : 0;
                  st.beginPath(),
                    (st.strokeStyle = r.color || nt.grid.markingsColor),
                    (st.lineWidth = f),
                    c
                      ? (st.moveTo(l.to + u, s.from), st.lineTo(l.to + u, s.to))
                      : (st.moveTo(l.from, s.to + u),
                        st.lineTo(l.to, s.to + u)),
                    st.stroke();
                } else
                  (st.fillStyle = r.color || nt.grid.markingsColor),
                    st.fillRect(l.from, s.to, l.to - l.from, s.from - s.to);
            }
          }
          ...
          if (v.show && 0 != v.ticks.length) {
            for (
              st.lineWidth = 1,
                ...
                v.innermost ||
                  ((st.strokeStyle = v.options.color),
                  st.beginPath(),
                  (x = b = 0),
                  "x" == v.direction ? (x = dt + 1) : (b = pt + 1),
                  1 == st.lineWidth &&
                    ("x" == v.direction
                      ? (g = Math.floor(g) + 0.5)
                      : (m = Math.floor(m) + 0.5)),
                  ...
                  st.lineTo(m + x, g + b),
                  st.stroke()),
                st.strokeStyle = v.options.tickColor,
                st.beginPath(),
                i = 0;
              i < v.ticks.length;
              ++i
        ...
        o &&
          ...
          "object" == typeof o || "object" == typeof n
            ? ("object" != typeof o &&
              ...
              o.top > 0 &&
                ((st.strokeStyle = n.top),
                (st.lineWidth = o.top),
                st.beginPath(),
                st.moveTo(0 - o.left, 0 - o.top / 2),
                st.lineTo(dt, 0 - o.top / 2),
                st.stroke()),
              o.right > 0 &&
                ((st.strokeStyle = n.right),
                (st.lineWidth = o.right),
                st.beginPath(),
                st.moveTo(dt + o.right / 2, 0 - o.top),
                st.lineTo(dt + o.right / 2, pt),
                st.stroke()),
              o.bottom > 0 &&
                ((st.strokeStyle = n.bottom),
                (st.lineWidth = o.bottom),
                st.beginPath(),
                st.moveTo(dt + o.right, pt + o.bottom / 2),
                st.lineTo(0, pt + o.bottom / 2),
                st.stroke()),
              o.left > 0 &&
                ((st.strokeStyle = n.left),
                (st.lineWidth = o.left),
                st.beginPath(),
                st.moveTo(0 - o.left / 2, pt + o.bottom),
                st.lineTo(0 - o.left / 2, 0),
                st.stroke()))
            : ((st.lineWidth = o),
              (st.strokeStyle = nt.grid.borderColor),
              st.strokeRect(-o / 2, -o / 2, dt + o, pt + o))),
          st.restore();
      }
      function O() {
        t.each(d(), function(t, i) {
                  ...
                  ("x" == i.direction
                    ...
                    : ((r = "middle"),
                      ...
                      "left" == i.position
                        ...
                        : (o = l.left + l.padding)),
                  at.addText(c, o, n, e.label, h, null, null, a, r));
        });
      }
      function L(t) {
      ...
      function R(t) {
        function i(t, i, e, o, n) {
          ...
          for (var c = r; c < a.length; c += r) {
            ...
            if (null != h && null != u) {
              ...
              (h != l || f != s) && st.moveTo(o.p2c(h) + i, n.p2c(f) + e),
                (l = u),
                (s = d),
                st.lineTo(o.p2c(u) + i, n.p2c(d) + e);
            }
          }
          st.stroke();
        }
        function e(t, i, e) {
          for (
            ...
            if (null != f && null != d) {
              ...
              if (
                (l || (st.beginPath(), st.moveTo(i.p2c(f), e.p2c(a)), (l = !0)),
                u >= e.max && p >= e.max)
              )
                st.lineTo(i.p2c(f), e.p2c(e.max)),
                  st.lineTo(i.p2c(d), e.p2c(e.max));
              else if (u <= e.min && p <= e.min)
                st.lineTo(i.p2c(f), e.p2c(e.min)),
                  st.lineTo(i.p2c(d), e.p2c(e.min));
              else {
                var m = f,
                  g = d;
                p >= u && u < e.min && p >= e.min
                  ...
                  u >= p && u > e.max && p <= e.max
                    ...
                    : p >= u &&
                      ...
                      ((d = ((e.max - u) / (p - u)) * (d - f) + f),
                      (p = e.max)),
                  f != m && st.lineTo(i.p2c(m), e.p2c(u)),
                  st.lineTo(i.p2c(f), e.p2c(u)),
                  st.lineTo(i.p2c(d), e.p2c(p)),
                  d != g &&
                    (st.lineTo(i.p2c(d), e.p2c(p)),
                    st.lineTo(i.p2c(g), e.p2c(p)));
              }
            }
          }
        }
        ...
        r && ((st.fillStyle = r), e(t.datapoints, t.xaxis, t.yaxis)),
      ...
      function B(t) {
        function i(t, i, e, o, n, a, r, l) {
          for (var s = t.points, c = t.pointsize, h = 0; h < s.length; h += c) {
            ...
            null == f ||
              ...
              (u = r.p2c(u) + o),
              "circle" == l
                ? st.arc(f, u, i, 0, n ? Math.PI : 2 * Math.PI, !1)
                : l(st, f, u, i, n),
              st.closePath(),
              e && ((st.fillStyle = e), st.fill()),
              st.stroke());
          }
        }
        st.save(), st.translate(ut.left, ut.top);
        ...
        if ((0 == e && (e = 1e-4), e > 0 && o > 0)) {
          var r = o / 2;
          (st.lineWidth = r),
            (st.strokeStyle = "rgba(0,0,0,0.1)"),
            i(t.datapoints, n, null, r + r / 2, !0, t.xaxis, t.yaxis, a),
            (st.strokeStyle = "rgba(0,0,0,0.2)"),
            i(t.datapoints, n, null, r / 2, !0, t.xaxis, t.yaxis, a);
        }
        (st.lineWidth = e),
          (st.strokeStyle = t.color),
          i(t.datapoints, n, E(t.points, t.color), 0, !1, t.xaxis, t.yaxis, a),
          st.restore();
      }
      ...
      function G() {
        if (
          (null != nt.legend.container
            ? t(nt.legend.container).html("")
          ...
          if (nt.legend.sorted)
            if (t.isFunction(nt.legend.sorted)) a.sort(nt.legend.sorted);
            else if ("reverse" == nt.legend.sorted) a.reverse();
            else {
          ...
          for (var s = 0; s < a.length; ++s) {
            var h = a[s];
            s % nt.legend.noColumns == 0 &&
              (r && n.push("</tr>"), n.push("<tr>"), (r = !0)),
              n.push(
                '<td class="legendColorBox"><div style="' +
                  nt.legend.labelBoxBorderColor +
                  '"><div style="border:2px solid ' +
                  h.color +
                  ';overflow:hidden"></div></div></td><td class="legendLabel"><span>' +
                  h.label +
                  "</span></td>"
              );
          }
          if ((r && n.push("</tr>"), 0 != n.length)) {
            var f =
              ...
              n.join("") +
              "</table>";
            if (null != nt.legend.container) t(nt.legend.container).html(f);
            else {
              var u = "",
              ...
              null == p[0] && (p = [p, p]),
                "n" == d.charAt(0)
                  ? (u += "top:" + (p[1] + ut.top) + "px;")
                  : "s" == d.charAt(0) &&
                    (u += "bottom:" + (p[1] + ut.bottom) + "px;"),
                "e" == d.charAt(1)
                  ? (u += "right:" + (p[0] + ut.right) + "px;")
                  : "w" == d.charAt(1) &&
                    (u += "left:" + (p[0] + ut.left) + "px;");
              var m = t(
                '<div class="legend">' +
              ...
              if (0 != nt.legend.backgroundOpacity) {
                ...
                t(
                  ...
                  .prependTo(m)
                  .css("opacity", nt.legend.backgroundOpacity);
              }
            }
          }
        }
      ...
      function Q(t, i, o) {
        ...
        if (
          (s &&
            ((s.pageX = parseInt(
              s.series.xaxis.p2c(s.datapoint[0]) + n.left + ut.left,
              10
            )),
            (s.pageY = parseInt(
              s.series.yaxis.p2c(s.datapoint[1]) + n.top + ut.top,
              10
            ))),
          nt.grid.autoHighlight)
        ) {
      ...
      function J() {
        ...
        for (t = 0; t < xt.length; ++t)
          (i = xt[t]),
            i.series.bars.show ? it(i.series, i.point) : tt(i.series, i.point);
      ...
      function $(t, i, e) {
        ...
        var n = Z(t, i);
        -1 == n
          ? (xt.push({ series: t, point: i, auto: e }), U())
          : e || (xt[n].auto = !1);
      }
      function K(t, i) {
        ...
        if (!(o < a.min || o > a.max || n < r.min || n > r.max)) {
          ...
          (o = a.p2c(o)),
            ...
            "circle" == i.points.symbol
              ? ct.arc(o, n, c, 0, 2 * Math.PI, !1)
              : i.points.symbol(ct, o, n, c, !1),
            ct.closePath(),
            ct.stroke();
        }
      }
      ...
      function et(i, e, o, n) {
        ...
        for (
          var a = st.createLinearGradient(0, o, 0, e),
            r = 0,
            l = i.colors.length;
          l > r;
          ++r
      ...
      var ot = [],
        ...
        ht = [],
        ft = [],
        ut = { left: 0, right: 0, top: 0, bottom: 0 },
        dt = 0,
        pt = 0,
        mt = {
          processOptions: [],
      ...
      (gt.setData = h),
        ...
        (gt.getAxes = function() {
          var i = {};
          return (
            t.each(ht.concat(ft), function(t, e) {
        ...
        (gt.c2p = p),
        (gt.p2c = m),
        (gt.getOptions = function() {
          return nt;
        }),
        (gt.highlight = $),
        (gt.unhighlight = K),
        (gt.triggerRedrawOverlay = U),
        (gt.pointOffset = function(t) {
          return {
...
!(function(e) {
  function n(e) {
    function n(e, n) {
      var l;
      for (l = 0; l < n.length; ++l) if (n[l].id === e.fillBetween) return n[l];
      return "number" == typeof e.fillBetween
        ? e.fillBetween < 0 || e.fillBetween >= n.length
          ? null
          : n[e.fillBetween]
        : null;
    }
        ...
        if (t) {
          for (
            ...
            if (((h = v.length), null == w[z])) {
              for (a = 0; g > a; ++a) v.push(w[z + a]);
              z += g;
            } else if (D >= c.length) {
              if (!d) for (a = 0; g > a; ++a) v.push(w[z + a]);
              z += g;
            } else if (null == c[D]) {
              for (a = 0; g > a; ++a) v.push(null);
              (b = !0), (D += B);
            } else {
              if (
                ((s = w[z]),
...
!(function(r) {
  function n(r) {
    function n(r, n, e) {
      ...
      if (t(n) && (l(n), a(r), o(r), s(n), v >= 2)) {
        var u = h(n),
          ...
          w = f();
        (p = c(u)
          ? -1 * d(g, u - 1, Math.floor(v / 2) - 1) - w
          : d(g, Math.ceil(v / 2), u - 2) + w + 2 * W),
          (i = b(e, n, p)),
          (e.points = i);
      }
      return i;
    ...
    function a(r) {
      var n = D
          ? r.getPlaceholder().innerHeight()
          : r.getPlaceholder().innerWidth(),
    ...
    function d(r, n, t) {
      for (var a = 0, e = n; t >= e; e++) a += r[e].bars.barWidth + 2 * W;
      return a;
    }
    function b(r, n, t) {
      for (
        var a = r.pointsize, e = r.points, o = 0, i = D ? 1 : 0;
        i < e.length;
        i += a
      )
    ...
    i.hooks.processOptions.push(function(e, i) {
      i.series.pie.show &&
        ...
        "auto" == i.series.pie.label.show &&
          (i.series.pie.label.show = !i.legend.show),
      ...
      e.each(r.getAxes(), function(e, r) {
        ...
        "time" == i.mode &&
          ((r.tickGenerator = function(e) {
            ...
            var g = M * s[f];
            "second" == f
              ? r.setSeconds(t(r.getSeconds(), M))
              : "minute" == f
                ? r.setMinutes(t(r.getMinutes(), M))
                : "hour" == f
                  ? r.setHours(t(r.getHours(), M))
                  : "month" == f
                    ? r.setMonth(t(r.getMonth(), M))
                    : "quarter" == f
                      ? r.setMonth(3 * t(r.getMonth() / 3, M))
                      : "year" == f && r.setFullYear(t(r.getFullYear(), M)),
              r.setMilliseconds(0),
              g >= s.minute && r.setSeconds(0),
              g >= s.hour && r.setMinutes(0),
              g >= s.day && r.setHours(0),
              g >= 4 * s.day && r.setDate(1),
              g >= 2 * s.month && r.setMonth(t(r.getMonth(), 3)),
              g >= 2 * s.quarter && r.setMonth(t(r.getMonth(), 6)),
              g >= s.year && r.setMonth(0);
            var y,
              S = 0,
              z = Number.NaN;
            do
    ...
    o = function(t) {
        ...
        n.tooltip !== !1 &&
          ...
          e(l).bind("plothover", function(e, t, i) {
            if (i) {
              var a;
              (a =
                "time" === n.xaxis.mode || "time" === n.xaxes[0].mode
                  ? d(p.content, i, s)
                  : d(p.content, i)),
                r
                  .html(a)
                  .css({ left: o.x + p.shifts.x, top: o.y + p.shifts.y })
                  .show();
            } else r.hide().html("");
          }),
          i.mousemove(a));
      ...
      var d = function(e, t, o) {
          var n = /%p\.{0,1}(\d{0,})/,
            ...
            s = /%y\.{0,1}(\d{0,})/;
          return (
            "undefined" != typeof t.series.percent &&
              (e = r(n, e, t.series.percent)),
            "undefined" != typeof t.series.label &&
              (e = e.replace(i, t.series.label)),
            "function" == typeof o
              ? (e = e.replace(a, o(t.series.data[t.dataIndex][0])))
              : "number" == typeof t.series.data[t.dataIndex][0] &&
                (e = r(a, e, t.series.data[t.dataIndex][0])),
            "number" == typeof t.series.data[t.dataIndex][1] &&
              (e = r(s, e, t.series.data[t.dataIndex][1])),
            e
          );
        },
        r = function(e, t, o) {
          ...
          return (
            "null" !== t.match(e) &&
              ("" !== RegExp.$1 && ((n = RegExp.$1), (o = o.toFixed(n))),
              (t = t.replace(e, o))),
            t
          );
        };
