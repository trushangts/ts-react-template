...
function checkVersion() {
  ...
  b > -1 &&
    (a =
      b >= 8
        ? "You're using a recent copy of Windows Internet Explorer."
        : "You should upgrade your copy of Windows Internet Explorer."),
    alert(a);
}
...
$(document).ready(function() {
  $("body").append("<div id='divSmallBoxes'></div>"),
    $("body").append(
      "<div id='divMiniIcons'></div><div id='divbigBoxes'></div>"
    );
});
var ExistMsg = 0,
  SmartMSGboxCount = 0,
...
$.SmartMessageBox = function(a, b) {
  ...
  (SmartMSGboxCount += 1),
    0 == ExistMsg &&
      ((ExistMsg = 1),
      (c =
        "<div class='divMessageBox animated fadeIn fast' id='MsgBoxBack'></div>"),
      $("body").append(c),
      1 == isIE8orlower() && $("#MsgBoxBack").addClass("MessageIE"));
  var g = "",
    h = 0;
  if (void 0 != a.input)
    switch (((h = 1), (a.input = a.input.toLowerCase()), a.input)) {
      case "text":
        (a.inputValue =
          "string" === $.type(a.inputValue)
            ? a.inputValue.replace(/'/g, "&#x27;")
            : a.inputValue),
          (g =
  ...
  (d =
    "<div class='MessageBoxContainer animated fadeIn fast' id='Msg" +
    SmartMSGboxCount +
    "'>"),
  ...
  var j = "",
    k = 0;
  void 0 == a.NormalButton && (a.NormalButton = "#232323"),
    void 0 == a.ActiveButton && (a.ActiveButton = "#ed145b");
      ...
      : "]" == a.buttons[i]
        ? ((k += 1),
          (j =
            ...
            "-Msg" +
            SmartMSGboxCount +
            "' class='btn btn-default btn-sm botTempo'> " +
            j +
            "</button>"),
          (d += j))
        : (j += a.buttons[i]);
...
$.bigBox = function(a, b) {
  ...
  if (
    ...
    a.sound && 0 == isIE8orlower())
  ) {
    var e = document.createElement("audio");
    navigator.userAgent.match("Firefox/")
      ? e.setAttribute("src", $.sound_path + a.sound_file + ".ogg")
      : e.setAttribute("src", $.sound_path + a.sound_file + ".mp3"),
      e.addEventListener(
        "load",
        function() {
          e.play();
  ...
  (BigBoxes += 1),
    (c =
      "<div id='bigBox" +
      BigBoxes +
      "' class='bigBox animated fadeIn fast'><div id='bigBoxColor" +
      BigBoxes +
      "'><i class='botClose fa fa-times' id='botClose" +
      BigBoxes +
      "'></i>"),
    (c += "<span>" + a.title + "</span>"),
    (c += "<p>" + a.content + "</p>"),
    ...
    $("#divMiniIcons").append(
      "<div id='miniIcon" +
        BigBoxes +
        "' class='cajita animated fadeIn' style='background-color: " +
        a.color +
        ";'><i class='" +
        a.icon +
        "'/></i></div>"
    ...
    $("#miniIcon" + BigBoxes).bind("click", function() {
      ...
      $(".cajita").each(function(a) {
        var b = $(this).attr("id"),
          c = b.replace("miniIcon", "bigBox");
        $("#" + c).css("z-index", 9998);
      }),
        $("#" + b).css("z-index", 9999),
        $("#" + c)
  ...
  if (
    (void 0 != a.colors &&
      ...
      (i = setInterval(function() {
        ...
        f.animate({ backgroundColor: a.colors[b].color }),
          g.animate({ backgroundColor: a.colors[b].color }),
          h.animate({ backgroundColor: a.colors[b].color }),
          b < a.colors.length - 1
            ? f.attr("colorcount", 1 * b + 1)
            : f.attr("colorcount", 0);
      }, a.colortime))),
    ...
    setTimeout(function() {
      clearInterval(i),
        $("#bigBox" + j).removeClass("fadeIn fast"),
        $("#bigBox" + j)
          .addClass("fadeOut fast")
          .delay(300)
          .queue(function() {
        ...
        $("#miniIcon" + j).removeClass("fadeIn fast"),
        $("#miniIcon" + j)
          .addClass("fadeOut fast")
          .delay(300)
          .queue(function() {
...
$.smallBox = function(a, b) {
  ...
  (SmallBoxes += 1), (c = "");
  var f = "",
    g = "smallbox" + SmallBoxes;
  if (
    ((f =
      void 0 == a.iconSmall
        ? "<div class='miniIcono'></div>"
        : "<div class='miniIcono'><i class='miniPic " +
          a.iconSmall +
          "'></i></div>"),
    (c =
      void 0 == a.icon
        ? "<div id='smallbox" +
          SmallBoxes +
          "' class='SmallBox animated fadeInRight fast'><div class='textoFull'><span>" +
          a.title +
          "</span><p>" +
          a.content +
          "</p></div>" +
    ...
    if (0 == h)
      ...
      $("#divSmallBoxes").append(c),
        ...
        (SmallBoxesAnchos =
          SmallBoxesAnchos + $("#smallbox" + SmallBoxes).height() + 20);
      var i = 0;
  ...
  void 0 == a.color
    ? j.css("background-color", "#004d60")
    : j.css("background-color", a.color);
  var k;
  void 0 != a.colors &&
    a.colors.length > 0 &&
    (j.attr("colorcount", "0"),
    (k = setInterval(function() {
      var b = j.attr("colorcount");
      j.animate({ backgroundColor: a.colors[b].color }),
        b < a.colors.length - 1
          ? j.attr("colorcount", 1 * b + 1)
          : j.attr("colorcount", 0);
    }, a.colortime))),
    void 0 != a.timeout &&
      setTimeout(function() {
              ...
              $(".SmallBox").each(function(a) {
                0 == a
                  ...
                  : ($(this).animate({ top: d }, 350),
                    (d = d + $(this).height() + 20),
                    (SmallBoxesAnchos =
                      SmallBoxesAnchos + $(this).height() + 20));
              });
            })
          : (clearInterval(k),
            (SmallBoxesAnchos -= a),
    ...
    $("#smallbox" + SmallBoxes).bind("click", function() {
      clearInterval(k), "function" == typeof b && b && b();
      var a = $(this).height() + 20;
